...
class Rents(models.Model):
	bookid=models.ForeignKey('Book',related_name="rent_bookid",on_delete=models.CASCADE)
	ISBN=models.ForeignKey('Book',related_name="rent_ISBN",on_delete=models.CASCADE)
	userid=models.ForeignKey('User',on_delete=models.CASCADE)
...
class Order(models.Model):
	...
	ISBN=models.ForeignKey('Book',related_name="order_ISBN",on_delete=models.CASCADE)
	paymentid=models.ForeignKey('Payment',on_delete=models.CASCADE)
